...
const UpdateIssueStatus = ({ title, message, images, upvotes, id, tags }) => {
    ...
    const handleSubmit = async(event) => {
        ...
        submitUpdate(updateTitle, msg);
    }
    const submitUpdate = async (title, message) => {
        try {
            setIsUpdating(true);
            ...
            const record = await updateReference.create([
                dateString,
                id,
                account.address,
                title,
        ...
        <div className='grid items-stretch grid-cols-2 gap-4 place-content-evenly'>
                ...
                <div className=' self-center max-w-md mx-auto rounded-xl shadow-md overflow-hidden md:max-w-2xl'>
                    <div className='p-8 bg-white self-stretch'>
                        ...
                        <div className='mt-4 flex justify-between'>
                            <div className='btn flex items-center cursor-default'>
            ...
            {/* <div className='col-span-2 md:col-span-1 border p-8 bg-white shadow-xl'>
                ...
                <ul className='timeline timeline-vertical lg:timeline-horizontal'>
                    <TimelineItemComponent year='9th Feb' event='Issue received' />
                    <TimelineItemComponent year='10th Feb' event='Issue submitted' />
                    <TimelineItemComponent
                        year='15rd Feb'
                        event='Nodal officer on-site'
                    />
                    <TimelineItemComponent year='23rd Feb' event='Workforce deployed' />
                </ul>
            </div> */}
